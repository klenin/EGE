...
sub all {[
    ...
    gg('A6', qw(count_by_sign find_min_max count_odd_even alg_min_max alg_avg bus_station bad_message convert_number inf_size bin_number)),
    ...
    gg('A13', qw(file_mask file_mask2 file_mask3 additional_inf_length)),
    gg('A14', qw(database)),
    gg('A15', qw(rgb)),
    ...
    gg('B03', qw(q1234 last_digit count_digits count_ones music_time_to_time music_size_to_size music_format_time_to_time)),
