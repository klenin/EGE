...
my $words = {
    ...
    dative => {
        ...
        s2 => [ qw(трем четырьм пяти шести семи восьми девяти) ],
        s3 => [ 'десяти',
            map $_ . 'надцати', qw(один две три четыр пят шест сем восем девят) ],
        s4 => [ qw(
            двадцати тридцати сорока пятидесяти шестидесяти семидесяти восьмидесяти девяноста) ],
    ...
    accusative => {
        ...
        s2 => [ qw(трех четырех пять шесть семь восемь девять) ],
        s3 => [ 'десять',
            map $_ . 'надцать', qw(один две три четыр пят шест сем восем девят) ],
        s4 => [ qw(
            двадцать тридцать сорок пятьдесять шестьдесять семьдесять восьмьдесять девяносто) ],
        s5 => [ qw(
            сто двести триста четыреста пятьсот шестьсот семьсот восемьсот девятьсот) ],
    },
    #творительный
    instrumental => {
        ...
        s2 => [ qw(тремя четырьмя пятью шестью семью восьмью девятью) ],
        s3 => [ 'десятью',
    ...
    prepositional => {
        ...
        s2 => [ qw(трех четырех пяти шести семи восьми девяти) ],
        s3 => [ 'десяти',
            map $_ . 'надцати', qw(один две три четыр пят шест сем восем девят) ],
        s4 => [ qw(
            двадцати тридцати сорока пятидесяти шестидесяти семидесяти восьмидесяти девяноста) ],
